...
Partial Class Funcionalidad_TiposDeMovsBancarios
...
#End Region
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            End If
            VerificaAccesos("TiposDeMovsBancarios")
...
#Region "Botones AGREGA,EDITA,CANCELA"
    ...
    Protected Sub cbEliminar_Callback(source As Object, e As CallbackEventArgs) Handles cbEliminar.Callback
        ...
        If glBusqueda.Value <> Nothing Then
            id = Convert.ToInt32(txtMovimiento.Text)
        End If
        Dim R() As String
        ...
        Resultado = fnc.Fun_Elimina(68, id, 1, Session("iIdUsuario"), "", 0, "", "ConexionDBS")
        R = Resultado.Split("|")
        ...
        Else
            ...
            cbEliminar.JSProperties("cpAccionE") = Resultado
        End If
    ...
    Private Sub CargaCallback()
        ...
        Dim dato As String = ""
        Dim id As Int32
        dato = Convert.ToString(txtDescrpcion.Text.Trim())
        Dim R() As String
        Dim R2() As String
...
"NULL"
        ...
        If (btnAgregar.Checked = False) And (btnEditar.Checked = True) Then
            id = Convert.ToInt32(txtMovimiento.Text)
            Resultado = fnc.Fun_Edita(68, cadena, id, Session("iIdUsuario"), "", 0, "", "ConexionDBS")
            R = Resultado.Split("|")
            If R(0) = "0" Then
        ...
        ElseIf (btnAgregar.Checked = True) And (btnEditar.Checked = False) Then
            Resultado = fnc.Fun_Nuevo(68, cadena, 2, dato, Session("iIdUsuario"), "", 0, "", "ConexionDBS")
            R2 = Resultado.Split("|")
            If R2(0) = "0" Then
                cbActualizar.JSProperties("cpAccion") = "Registro agregado con éxito."
                cbActualizar.JSProperties("cpMovimiento") = R2(1)
                idnew_Global = R2(1)
            Else
                cbActualizar.JSProperties("cpAccion") = Resultado
            End If
...
#End Region
    ...
    Public Sub LlenarBusqueda()
        ...
        glBusqueda.Columns.Clear()
        tabla = fnc.TraeDatosConsulta("SELECT * FROM cve_movimientos where borradoLogico = 0", "ConexionDBS")
        ...
        If tabla.Tables.Count > 0 Then
            If tabla.Tables(0).Rows.Count > 0 Then
                ...
                For j As Integer = 0 To tabla.Tables(0).Columns.Count - 1
                    ...
                    If ColumnaGridt.Caption = "cve_movimiento" Then
                        ColumnaGridt.Caption = "ID Movimiento"
