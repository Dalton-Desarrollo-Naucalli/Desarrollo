<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MatricesContablesII.aspx.vb" Inherits="Funcionalidad_MatricesContablesII" %>
...
<head runat="server">
    ...
    <script src="../funcionesJS/MatricesContablesII.js"></script>
    <title>Matrices contables II</title>
     <style>         
        .AlignButtonRigth {
             margin-left:92%                        
        }         
...
alert(s.cpAccion);
glBusqueda.GetGridView().Refresh();
 if (cmbTipoGasto.GetValue() == '') {
cmbTipoGasto.SetValue(s.cpMC2);}
BloqueaAgrega();                                        
}
...
" />
            ...
            <dx:ASPxRoundPanel ID="ASPxRoundPanel5" runat="server" HeaderText="Búsqueda:" Font-Size="Medium" Font-Bold="false" Width="100%">
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        ...
                        <dx:ASPxGridLookup ID="glBusqueda" ClientInstanceName="glBusqueda" Font-Size="Medium" ClientIDMode="AutoID" runat="server" Width="30%" KeyFieldName="id_tipogasto" AutoGenerateColumns="False" TextFormatString="{1} | {0}">
                            

                            <GridViewProperties>

                                <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" AllowDragDrop="False" AutoFilterRowInputDelay="4000" />
	...
	GVMatriz2.Refresh();
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="Matrices contables II" Font-Bold="true" Font-Size="Large" Width="100%">
            <PanelCollection>
                <dx:PanelContent runat="server">
                    <asp:Label ID="lblAccesos" runat="server" CssClass="GlobalTextoPanel" Visible="false"></asp:Label>
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <dx:ASPxGridView ID="GVMatriz2" runat="server" AutoGenerateColumns="False" Font-Size="Medium" ClientIDMode="AutoID" ClientInstanceName="GVMatriz2" Width="100%" KeyFieldName="id_tipogasto;ID_centro_costo" SettingsCommandButton-CancelButton-Text="Cancelar" SettingsCommandButton-UpdateButton-Text="Guardar" ForeColor="Black">
...
" />
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxButton ID="btnVerReporte" runat="server" Text="Ver reporte" CssClass="AlignButtonRigth"></dx:ASPxButton>
                                        </td>                                     
                                    </tr>
                                </table>
