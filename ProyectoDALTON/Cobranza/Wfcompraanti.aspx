<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Wfcompraanti.aspx.vb" Inherits="MiFuncionalidad_Wfcompraanti" %>
...
<body>
    <form id="form1" runat="server">
         ...
         <dx:ASPxRoundPanel ID="ASPxRoundPanel2" runat="server" ShowCollapseButton="True" ShowHeader="False" Theme="Office2003Blue" Width="150%">
            <PanelCollection>
        ...
        <br />
           ...
           <dx:ASPxRoundPanel ID="ASPxRoundPanel5" runat="server" ShowCollapseButton="True" ShowHeader="False" Theme="Office2003Olive" style="width:150%">
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        ...
                        <table style="width:200%">
                            ...
                            <tr>
                                ...
                                <td >
                                   <dx:ASPxLabel ID="ASPxLabel121" runat="server" Text="Linea de fondeo" Font-Size="Medium" Width="40%" Style="text-align:left"></dx:ASPxLabel>
...
<br />
         ...
         <dx:ASPxRoundPanel ID="ASPxRoundPanel3" runat="server" ShowCollapseButton="True" ShowHeader="False" Theme="Office2003Blue" Width="150%">
          <PanelCollection>
             <dx:PanelContent runat="server">



         <dx:ASPxPageControl ID="prod" runat="server" ActiveTabIndex="0" EnableTheming="True" Theme="Office2010Blue" Width="150%">
                            <TabPages>

                               <dx:TabPage Name="tabMnto" Text="Autos pendientes por facturar-compra anticipada">
                                    <ContentCollection>
                                              ...
                                              <table style="width:67%">
                                                  <tr>
                                                      ...
                                                      <td>
                                                       ...
                                                       <td>
                                                          <asp:RadioButton ID="RadioButton4" Text="Incluir facturados" style="Font-Size:medium" runat="server" />
                                                      </td>
                                                  </tr>
                                            ...
                                            <table style="width:67%">
                                                <tr>
                                                    <td>
                                                     ...
                                                     <td style="text-align:center">
                                                         <dx:ASPxLabel ID="ASPxLabel50" runat="server" style="text-align:center" Font-Size="small" Text="VIN">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td style="text-align:center">
                                                         <dx:ASPxLabel ID="ASPxLabel51" runat="server" style="text-align:center" Font-Size="small" Text="Arrendatario">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel185" runat="server" Font-Size="Small" Text="Valor recidual">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel145" runat="server" Font-Size="Small" Text="Fecha de terminación">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel153" runat="server" Font-Size="Small" Text="Fecha de vencimiento">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td >
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel169" runat="server" Font-Size="Small" Text="Agencia">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel177" runat="server" Font-Size="Small" Text="Promotor">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                     ...
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel161" runat="server" Font-Size="Small" Text="Tipo de terminación">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel186" runat="server" Font-Size="Small" Text="$126,000.00">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel146" runat="server" Font-Size="Small" Text="20/09/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel154" runat="server" Font-Size="Small" Text="30/09/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel170" runat="server" Font-Size="Small" Text="Dalton polanco">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel178" runat="server" Font-Size="Small" Text="Jose Martínez Rosas">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel122" runat="server" Font-Size="Small" Text="Pagado">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel162" runat="server" Font-Size="Small" Text="Plazo natural">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr> <tr>
                                                <td colspan="2">&nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel187" runat="server" Font-Size="Small" Text="$193,200.00">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel147" runat="server" Font-Size="Small" Text="15/09/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel155" runat="server" Font-Size="Small" Text="29/09/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel171" runat="server" Font-Size="Small" Text="Dalton polanco">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel179" runat="server" Font-Size="Small" Text="Erick Gonzalez Brito">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                     ...
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel163" runat="server" Font-Size="Small" Text="Siniestro">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel188" runat="server" Font-Size="Small" Text="$142,800.00">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel148" runat="server" Font-Size="Small" Text="08/09/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel156" runat="server" Font-Size="Small" Text="08/10/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel172" runat="server" Font-Size="Small" Text="Dalton polanco">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel180" runat="server" Font-Size="Small" Text="Gabriela Ponce Granados">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                     ...
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel164" runat="server" Font-Size="Small" Text="Jurídico">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel189" runat="server" Font-Size="Small" Text="$168,000.00">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel149" runat="server" Font-Size="Small" Text="11/09/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel157" runat="server" Font-Size="Small" Text="11/10/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel173" runat="server" Font-Size="Small" Text="Dalton polanco">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel181" runat="server" Font-Size="Small" Text="Martin Lopez Venegas">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel165" runat="server" Font-Size="Small" Text="Entrega anticipada">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel190" runat="server" Font-Size="Small" Text="$289,800.00">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                     ...
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel150" runat="server" Font-Size="Small" Text="20/09/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel158" runat="server" Font-Size="Small" Text="20/10/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel174" runat="server" Font-Size="Small" Text="Dalton polanco">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel182" runat="server" Font-Size="Small" Text="Michelle Webber Carranco">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                     ...
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel166" runat="server" Font-Size="Small" Text="Compra anticipada">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel191" runat="server" Font-Size="Small" Text="$120,120.00">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel151" runat="server" Font-Size="Small" Text="10/09/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel159" runat="server" Font-Size="Small" Text="10/10/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel175" runat="server" Font-Size="Small" Text="Dalton polanco">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel183" runat="server" Font-Size="Small" Text="Thamara Mendoza Flores">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel167" runat="server" Font-Size="Small" Text="Plazo natural">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel192" runat="server" Font-Size="Small" Text="$157,080.00">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel152" runat="server" Font-Size="Small" Text="30/09/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel160" runat="server" Font-Size="Small" Text="30/10/2017">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel176" runat="server" Font-Size="Small" Text="Dalton polanco">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                         <dx:ASPxLabel ID="ASPxLabel184" runat="server" Font-Size="Small" Text="Diego Gonzalez Savala">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                     ...
                                                     <td>
                                                         <dx:ASPxLabel ID="ASPxLabel168" runat="server" Font-Size="Small" Text="Jurídico">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                            </table>
                                             ...
                                             <dx:TabPage Name="tabMnto" Text="Solicitud de facturación activo fijo-compra aticipada">
                                    <ContentCollection>
                                        <dx:ContentControl runat="server"> 
                                                ...
                                                <td  colspan="4"     class="dxrpHeader_Office2010Blue dx-borderBox" style="width:100%">
                                                 ...
                                                 <tr>
                                                     <td>
                                                      ...
                                                      <td>
                                                          <dx:ASPxLabel ID="ASPxLabel143" runat="server" Font-Size="Medium" style="text-align:right" Text="Linea de fondeo:">
                                                        </dx:ASPxLabel>
                                                     </td>
                                                      <td>
                                                          <dx:ASPxLabel ID="ASPxLabel144" runat="server" Font-Size="Medium" style="text-align:right" Text="BURSA">
                                                        </dx:ASPxLabel>
                                                     </td>
                                                      <td>
                                                          &nbsp;</td>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                      ...
                                                      <td>
                                                         <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Size="Medium" style="text-align:right" Text="7462">
                                                        </dx:ASPxLabel>
                                                     </td>
                                                      <td>
                                                      ...
                                                      <td>
                                                         <dx:ASPxLabel ID="ASPxLabel4" runat="server" Font-Size="Medium" style="text-align:right" Text="8365">
                                                        </dx:ASPxLabel>
                                                     </td>
                                                 </tr>
                                                  <tr>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                      ...
                                                      <td>
                                                         <dx:ASPxLabel ID="ASPxLabel136" runat="server" Font-Size="Medium" style="text-align:right" Text="Transportes sur S.A">
                                                        </dx:ASPxLabel>
                                                     </td>
                                                      <td>
                                                      ...
                                                      <td>
                                                         <dx:ASPxLabel ID="ASPxLabel138" runat="server" Font-Size="Medium" style="text-align:right" Text="Pedro Juarez García">
                                                        </dx:ASPxLabel>
                                                     </td>
                                                 </tr>
                                                  <tr>
                                                 ...
                                                 <td>
                                                      ...
                                                      <td>
                                                         <dx:ASPxLabel ID="ASPxLabel142" runat="server" Font-Size="Medium" style="text-align:right" Text="12/36">
                                                        </dx:ASPxLabel>
                                                     </td>
                                                     </tr>
                                                ...
                                                <td  colspan="2"     class="dxrpHeader_Office2010Blue dx-borderBox" style="width:100%">
                                                 ...
                                                 <tr>
                                                     <td>
                                                      ...
                                                      <td>
                                                         <dx:ASPxLabel ID="ASPxLabel37" runat="server" Font-Size="Medium" style="text-align:right" Text="Pedro Juarez García">
                                                        </dx:ASPxLabel>
                                                     </td>
                                                  ...
                                                  <tr>
                                                     <td>
                                                      ...
                                                      <td>
                                                         <dx:ASPxLabel ID="ASPxLabel39" runat="server" Font-Size="Medium" style="text-align:right" Text="JUGP700505A63">
                                                        </dx:ASPxLabel>
                                                     </td>
